...
SELECT NAME,AGE FROM MUJICA WHERE AGE<50 AND AGE>10 ORDER BY AGE ASC LIMIT 0,5;
SELECT NAME,AGE FROM MUJICA WHERE AGE BETWEEN 11 AND 49 ORDER BY AGE ASC LIMIT 5; -- BETWEEN是闭区间，LIMIT第一个0可以省略。
